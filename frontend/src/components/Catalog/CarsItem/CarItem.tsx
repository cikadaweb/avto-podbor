...
import {Button, Card, CardActions, CardContent, Chip, Stack} from "@mui/material";
...
import {MileageStatusColors, MileageStatusDescriptions} from "../../../constants/MileageStatuses";
            ...
            <CardContent>
                <Grid container direction="column" justifyContent="space-between" spacing={2}>
                    ...
                    <Grid size={12}>
                        <Grid container direction="column" justifyContent="space-between" spacing={2}>
                            <Grid size={12}>
                                <Typography sx={{fontSize: '30px'}} variant="h5" component="div">
                                    {car.title}
                                </Typography>
                            </Grid>

                            <Grid container direction="column" size={12}>
                                <Grid container justifyContent="space-between" spacing={2} sx={{flexWrap: 'false'}}>
                                    <Grid>
                                        <Typography variant="body2" component="span">Пробег: .............................</Typography>
                                    </Grid>
                                ...
                                <Grid container justifyContent="space-between">
                                    <Grid>
                                        <Typography variant="body2" component="span">Оценка: ....</Typography>
                                    </Grid>
                                    <Chip
